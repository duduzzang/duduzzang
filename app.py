...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def loadFile(self, filename=None):
        ...
        if QtCore.QFile.exists(label_file) and LabelFile.is_label_file(
            ...
            self.raw_DicomData = pydicom.dcmread(filename)

            pat_name = self.raw_DicomData.PatientName
            display_name = pat_name.family_name + ", " + pat_name.given_name
            self.Patient_Name = display_name
            self.Patient_ID = self.raw_DicomData.PatientID
            self.Modality = self.raw_DicomData.Modality
            self.Study_Date = self.raw_DicomData.StudyDate
